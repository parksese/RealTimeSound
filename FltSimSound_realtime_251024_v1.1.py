...
class TableLookup:
    def __init__(self):
        table = np.array([
            ...
            [60.0, 1, -10, 60, 550.69,    0.00,     0.00,    0.00,    0.00], # case6 17.6 rad/s = 168 rpm
            [60.0, 1,  -5, 60,  550.69,    0.00,     0.00,    0.00,    0.00],
            [60.0, 1,   0, 60, 550.69,    0.00,     0.00,    0.00,    0.00], 
            [60.0, 1,   5, 60, 550.69,    0.00,     0.00,    0.00,    0.00], 
            [60.0, 1,  10, 60, 550.69,    0.00,     0.00,    0.00,    0.00],
            [67.0, 1, -10, 60, 550.69,    0.00,     0.00,    0.00,    0.00], # case6 17.6 rad/s = 168 rpm
            [67.0, 1,  -5, 60,  550.69,    0.00,     0.00,    0.00,    0.00],
            [67.0, 1,   0, 60, 550.69,    0.00,     0.00,    0.00,    0.00], 
            [67.0, 1,   5, 60, 550.69,    0.00,     0.00,    0.00,    0.00], 
            [67.0, 1,  10, 60, 550.69,    0.00,     0.00,    0.00,    0.00],
            [85.0, 0, -10, 60, 550.69,    0.00,     0.00,    0.00,    0.00], # case7 17.6 rad/s = 168 rpm
            [85.0, 0,  -5, 60,  550.69,    0.00,     0.00,    0.00,    0.00],            
            [85.0, 0,   0, 60, 550.69,    0.00,     0.00,    0.00,    0.00], 
            [85.0, 0,   5, 60,  550.69,    0.00,     0.00,    0.00,    0.00],
            [85.0, 0,  10, 60, 550.69,    0.00,     0.00,    0.00,    0.00],
